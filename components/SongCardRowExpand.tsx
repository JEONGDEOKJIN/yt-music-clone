  ...
  return (
    <article className="flex flex-row items-center gap-4 h-[48px] w-full relative group ">
      <div className="w-[48px] h-[48px] relative">
        ...
        <section
          className="hidden group-hover:flex w-[48px] h-[48px] items-center justify-center absolute top-0 bg-black
            cursor-pointer"
        >
      ...
      <section className="hidden group-hover:flex  absolute top-0 right-0  flex-row h-[48px] w-[120px] bg-[rgba(0,0,0,0.7)] items-center justify-end">
